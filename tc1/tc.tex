...
\input{textos/abstract.tex}
\listoffigures
\listoftables
\tableofcontents

\input{textos/01.introducao.tex}
\input{textos/02.fundamentacao_teorica.tex}
\input{textos/03.trabalhos_relacionados.tex}
\input{textos/04.metodologia.tex}
\input{textos/05.sistema.tex}
\input{textos/06.conclusao.tex}
